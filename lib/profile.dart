           ...
           Column(children: [
                ...
                builder: (context, snapshot) {
                  ...
                  backgroundColor: Colors.white
                                      ...
                                      Row( mainAxisAlignment: MainAxisAlignment.center,
                                        children: [
                                        Text(snapshot.data!.firstName.toString(),style: TextStyle(fontSize: 18, color: Colors.black),),
                                        SizedBox(width: 5,),
                                         Text(snapshot.data!.lastName.toString(),style: TextStyle(fontSize: 18,),),
                                      ],),
                                    SizedBox(height: 5,),
                                      Text(snapshot.data!.email.toString(),style: TextStyle(fontSize: 16,  color: HexColor("#000000"),)),
                                    SizedBox(
                                    height: 10,
                                    ),
                                 ...
                                 Row( mainAxisAlignment: MainAxisAlignment.center,
                                   children: [
                                      Text("Last login:",style: TextStyle(fontSize: 14, ),),
                                        SizedBox(width: 5,),
                                      Text(snapshot.data!.lastLogin.toString(),style: TextStyle(fontSize: 14,),),
              ...
              Row(
                ...
                children: [
                  ...
                  Text('Appoint Date', style: TextStyle(fontSize: 15,),),
                  SizedBox(
                    width: 12,
                  ),
                  Text('Appoint Time', style: TextStyle(fontSize: 15,),),
                  SizedBox(
                    width: 12,
                  ),
              ...
              Expanded(
                child: FutureBuilder(
                    ...
                    builder:
                        (context, AsyncSnapshot<List<profileModel>> snapshot) {
                      if (snapshot.data != null) {
                        return ListView.builder(
                            shrinkWrap: true,
                            // scrollDirection: ax,
