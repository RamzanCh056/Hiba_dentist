      ...
      child: SafeArea(
        child: Column(children: [
          ...
          Padding(
            ...
            child: Text('We Are A Certified and Award Winning Dental Clinic You Can Trust',
              style: TextStyle(
                  ...
                  Center(
                    ...
                    Padding(
                      ...
                      child: MaterialButton(
                        ...
                        onPressed: (){},child: Text('Make Appointment',style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
                      ),
                    ),
                ],),
              ),
